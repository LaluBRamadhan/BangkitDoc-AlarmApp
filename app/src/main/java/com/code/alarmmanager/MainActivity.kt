...
import com.code.alarmmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    override fun onClick(v: View) {
        when(v.id){
            ...
            R.id.btn_once_time -> {
                val timePickerManager = TimePickerFragment()
                timePickerManager.show(supportFragmentManager, TIME_PICKER_ONCE_TAG)
            }
